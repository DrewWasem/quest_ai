...
const SKELETON_VIGNETTES: Vignette[] = [
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'spawn', asset: 'pizza_whole', position: 'cs-center' }, { action: 'react', effect: 'confetti-burst', position: 'cs-center' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'react', effect: 'confetti-burst', position: 'cs-center' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
...
const CLOWN_VIGNETTES: Vignette[] = [
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'animate', character: 'clown', anim: 'celebrate' }, { action: 'react', effect: 'laugh-tears', position: 'cs-center' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'animate', character: 'clown', anim: 'celebrate' }, { action: 'react', effect: 'confetti-burst', position: 'cs-center' }, { action: 'text_popup', text: '🎪 PERFECT LANDING! 🎪', position: 'center', size: 'huge' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'animate', character: 'clown', anim: 'celebrate' }, { action: 'react', effect: 'confetti-burst', position: 'cs-center' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
...
const SUPERHERO_VIGNETTES: Vignette[] = [
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'animate', character: 'superhero', anim: 'celebrate' }, { action: 'react', effect: 'confetti-burst', position: 'cs-center' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'animate', character: 'superhero', anim: 'celebrate' }, { action: 'react', effect: 'stars-spin', position: 'cs-center' }, { action: 'text_popup', text: '🍕 PERFECT PATTERN! 🍕', position: 'center', size: 'huge' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'animate', character: 'superhero', anim: 'celebrate' }, { action: 'react', effect: 'stars-spin', position: 'cs-center' }, { action: 'text_popup', text: '🎂 PERFECT BAKE! 🎂', position: 'center', size: 'huge' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'animate', character: 'superhero', anim: 'celebrate' }, { action: 'react', effect: 'confetti-burst', position: 'cs-center' }, { action: 'text_popup', text: '🦸 MYSTERY SOLVED! 🦸', position: 'center', size: 'huge' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
...
const SURVIVALIST_VIGNETTES: Vignette[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'spawn', asset: 'cake_giant', position: 'cs-center' }, { action: 'react', effect: 'confetti-burst', position: 'cs-center' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
...
const EVERYONE_VIGNETTES: Vignette[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { parallel: [{ action: 'animate', character: 'skeleton_warrior', anim: 'celebrate' }, { action: 'animate', character: 'clown', anim: 'celebrate' }, { action: 'animate', character: 'superhero', anim: 'celebrate' }, { action: 'react', effect: 'confetti-burst', position: 'cs-center' }, { action: 'sfx', sound: 'success' }], delayAfter: 1.5 },
    ],
...
export const SKELETON_PIZZA_STAGE_2: Vignette[] = [
  ...
  // ── CROSS: survivalist + soup + warm + family_size ─────────────────────────
  {
    ...
    steps: [
      ...
      {
        parallel: [
          { action: 'animate', character: 'survivalist', anim: 'celebrate' },
          { action: 'react', effect: 'confetti-burst', position: 'center' },
