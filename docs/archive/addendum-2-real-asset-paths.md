# Addendum 2: REAL Asset Paths & Corrected Substitution Map

**This replaces the generic ASSET_SUBSTITUTIONS in Addendum 1 with actual file paths from the 7,834 asset library.**

All paths are relative to `frontend/public/assets/3d/`.

---

## Complete Asset Substitution Map (Real Paths)

```typescript
const ASSET_SUBS: Record<string, AssetEntry> = {

  // =====================================================
  // FOOD — You have a MASSIVE food library. Use it all.
  // Sources: kaykit/restaurant, quaternius/food, quaternius/japanese-food,
  //          poly-pizza/food/*, tiny-treats/pleasant-picnic, tiny-treats/baked-goods
  // =====================================================
  ...
  'stew':               { path: 'kaykit/packs/restaurant/food_stew.gltf', fallback: 'kaykit/packs/restaurant/stew_bowl.gltf' },
  'stew_pot':           { path: 'kaykit/packs/restaurant/stew_pot.gltf', fallback: 'kaykit/packs/restaurant/pot_A_stew.gltf' },
  ...
  'veggie_burger':      { path: 'kaykit/packs/restaurant/food_vegetableburger.gltf' },

  // --- Ice Cream (great for comedy — stacking, falling, melting) ---
  ...
  'icecream_machine':    { path: 'kaykit/packs/restaurant/icecream_machine.gltf' },

  // --- Ingredients (great for "flying food" chaos) ---
  ...
  'wine_bottle':        { path: 'tiny-treats/pleasant-picnic/wine_bottle.gltf' },

  // --- Baked Goods (Tiny Treats) ---
  // Check what's actually in this pack:
  // tiny-treats/baked-goods/ has 32 files — cakes, cookies, pies, pastries
  ...
  // --- Kitchen Equipment (for Mage Kitchen quest) ---
  ...
  // Sources: kaykit/dungeon, kaykit/furniture, tiny-treats/*, living-room
  // =====================================================
  ...
  'bed_decorated':       { path: 'kaykit/packs/dungeon/bed_decorated.gltf' },
  ...
  // =====================================================
  // CONTAINERS (throwable, stackable, breakable)
  // =====================================================
  ...
  'crate_cheese':        { path: 'kaykit/packs/restaurant/crate_cheese.gltf' },

  // =====================================================
  // PARTY / DECORATIONS / CELEBRATIONS
  // Sources: kaykit/holiday, kaykit/halloween, kaykit/dungeon (banners)
  // =====================================================

  // --- Banners (TONS of color variants) ---
  ...
  // --- Presents (30 variants! Great for party/birthday scenes) ---
  ...
  // --- Halloween (SKELETON BIRTHDAY QUEST GOLD) ---
  ...
  // --- Candy (for raining, throwing, chaos) ---
  ...
  // =====================================================
  // DUNGEON PROPS (atmosphere, slapstick props)
  // =====================================================
  ...
  // =====================================================
  // WEAPONS / TOOLS / RPG (slapstick, not violence)
  // Sources: kaykit/rpg_tools, poly-pizza/fantasy
  // =====================================================
  ...
  'skull_fantasy':       { path: 'poly-pizza/fantasy/fantasy-bundle/Skull.glb' },
  'axe':                 { path: 'kaykit/packs/rpg_tools/axe.gltf' },
  'hammer':              { path: 'kaykit/packs/rpg_tools/hammer.gltf' },
  ...
  'saw':                 { path: 'kaykit/packs/rpg_tools/saw.gltf' },

  // =====================================================
  // ANIMALS (background chaos, surprise appearances)
  // Sources: poly-pizza/animals/*
  // =====================================================
  ...
  'wolf':                { path: 'poly-pizza/animals/animated-animal-pack/Wolf.glb' },
  'trex':                { path: 'poly-pizza/animals/animated-dinosaur-bundle/T-Rex.glb' },
  'spider':              { path: 'poly-pizza/fantasy/animated-enemies/Spider.glb' },
  'rat':                 { path: 'poly-pizza/fantasy/animated-enemies/Rat.glb' },
  'snake':               { path: 'poly-pizza/fantasy/animated-enemies/Snake.glb' },
  'rubber_duck':         { path: 'poly-pizza/misc/cutes-part-one/Rubber Duck.glb' },

  // =====================================================
  // NATURE / ENVIRONMENT
  // Sources: kaykit/forest_nature, tiny-treats/pretty-park, quaternius/nature
  // =====================================================
  ...
  // =====================================================
  // CONCERT / MUSIC (Dungeon Concert quest)
  // Source: poly-pizza/misc/concert-pack
  // =====================================================
  ...
  'spot_light':          { path: 'poly-pizza/misc/concert-pack/Spot Light.glb' },
  'barricade':           { path: 'poly-pizza/misc/concert-pack/Barricade.glb' },

  // =====================================================
  // SPACE (Knight Space quest)
  // Sources: kaykit/space_base, poly-pizza/space/*
  // =====================================================
  ...
  // Sources: quaternius/items, poly-pizza/fantasy, quaternius/game-mechanics
  // =====================================================
  ...
  // =====================================================
  // PICNIC (Adventurer Picnic quest)
  // Source: tiny-treats/pleasant-picnic
  // =====================================================
  ...
  'pillow_picnic_blue':  { path: 'tiny-treats/pleasant-picnic/pillow_large_blue.gltf' },
  'pillow_picnic_red':   { path: 'tiny-treats/pleasant-picnic/pillow_large_red.gltf' },

  // =====================================================
  // PLAYGROUND / KIDS ROOM (for variety scenes)
  // Source: tiny-treats/fun-playground, tiny-treats/playful-bedroom
  // =====================================================
  ...
  // =====================================================
  // CHARACTERS (41 available — use for NPCs, crowd, guests)
  // Source: kaykit/characters
  // =====================================================

  'knight':              { path: 'kaykit/characters/Knight.glb' },
  'mage':                { path: 'kaykit/characters/Mage.glb' },
  'barbarian':           { path: 'kaykit/characters/Barbarian.glb' },
  'skeleton_warrior':    { path: 'kaykit/characters/Skeleton_Warrior.glb' },
  'skeleton_mage':       { path: 'kaykit/characters/Skeleton_Mage.glb' },
  'skeleton_minion':     { path: 'kaykit/characters/Skeleton_Minion.glb' },
  'skeleton_rogue':      { path: 'kaykit/characters/Skeleton_Rogue.glb' },
  'skeleton_golem':      { path: 'kaykit/characters/Skeleton_Golem.glb' },
  'necromancer':         { path: 'kaykit/characters/Necromancer.glb' },
  'witch':               { path: 'kaykit/characters/Witch.glb' },
  'vampire':             { path: 'kaykit/characters/Vampire.glb' },
  'rogue':               { path: 'kaykit/characters/Rogue.glb' },
  'rogue_hooded':        { path: 'kaykit/characters/Rogue_Hooded.glb' },
  'ranger':              { path: 'kaykit/characters/Ranger.glb' },
  'paladin':             { path: 'kaykit/characters/Paladin.glb' },
  'ninja':               { path: 'kaykit/characters/Ninja.glb' },
  'druid':               { path: 'kaykit/characters/Druid.glb' },
  'clown':               { path: 'kaykit/characters/Clown.glb' },
  'superhero':           { path: 'kaykit/characters/Superhero.glb' },
  'space_ranger':        { path: 'kaykit/characters/SpaceRanger.glb' },
  'robot':               { path: 'kaykit/characters/Robot_One.glb' },
  'werewolf':            { path: 'kaykit/characters/Werewolf_Man.glb' },
  'frost_golem':         { path: 'kaykit/characters/FrostGolem.glb' },
  'hiker':               { path: 'kaykit/characters/Hiker.glb' },
  'engineer':            { path: 'kaykit/characters/Engineer.glb' },
  'black_knight':        { path: 'kaykit/characters/BlackKnight.glb' },
  'caveman':             { path: 'kaykit/characters/Caveman.glb' },

  // =====================================================
  // ULTIMATE FALLBACKS (always work, generic shapes)
  // =====================================================

  'gift':                { path: 'kaykit/packs/block/gift.gltf' },          // Generic present box
  'dynamite':            { path: 'kaykit/packs/block/dynamite.gltf' },      // Comedy explosive
  'apple_block':         { path: 'kaykit/packs/block/apple.gltf' },         // Simple apple
  'chest_block':         { path: 'kaykit/packs/block/chest.gltf' },         // Simple chest
  'barrel_block':        { path: 'kaykit/packs/block/barrel.gltf' },        // Simple barrel
  'mystery_crate':       { path: 'kaykit/packs/dungeon/box_small_decorated.gltf' }, // Mystery box fallback
};
```

## Tag-to-Asset Category Map (For Substitution Engine)

When Claude generates an option that maps to a tag, the engine picks from these categories:

```typescript
const TAG_TO_ASSETS: Record<string, string[]> = {
  // Food tags — pick randomly from the array for variety
  'food_pizza':     ['pizza', 'pizza_slice', 'pizza_box'],
  'food_cake':      ['cookie', 'gingerbread_house'],  // No cake model, but cookies + gingerbread work
  'food_burger':    ['burger', 'veggie_burger'],
  'food_soup':      ['stew', 'stew_pot'],
  'food_feast':     ['dinner_plate', 'plate_food', 'stew_bowl', 'sandwich'],
  ...
  'vibe_silly':     ['rubber_duck', 'clown', 'chicken', 'play_block', 'piggybank', 'gingerbread_man'],
  ...
  'crowd_heroes':   ['knight', 'mage', 'barbarian', 'ranger', 'paladin', 'rogue'],
  'crowd_weird':    ['clown', 'robot', 'superhero', 'ninja', 'caveman', 'space_ranger'],
  'crowd_spooky':   ['necromancer', 'witch', 'vampire', 'werewolf', 'skeleton_golem'],

  // Animals (background chaos agents)
  'animal_farm':    ['chicken', 'cow', 'pig', 'sheep', 'horse', 'duck'],
  'animal_pet':     ['cat', 'dog', 'corgi', 'rabbit'],
  'animal_wild':    ['bear', 'fox', 'wolf', 'deer'],
  'animal_chaos':   ['trex', 'shark', 'spider', 'frog', 'llama'],
  'animal_cute':    ['chick', 'penguin', 'rubber_duck', 'bird'],
};
```

## Notes on Missing Assets & Creative Substitutions

Things you DON'T have but kids will expect:

| Concept | Substitution Strategy |
|---------|----------------------|
| **Cake** | Use `gingerbread_house_decorated` or stack `cookie` models. Or scale up `icecream_bowl_decorated_A` |
| **Balloons** | Use `present_sphere_A_red/blue/green` (round presents!) with float-up animation |
| **Musical instruments** | Use `microphone` + `speaker` from concert pack. Guitar = fishing_rod held differently lol |
| **Fireworks** | `dynamite` + explosion particles + `star` items raining down |
| **Dance floor** | `rug_rectangle_A` + `spotlight` from concert pack |
| **Flying carpet** | `rug_rectangle_A` with float animation + `sparkle` particles |
| **Birthday hat** | Scale down `candle_lit` on character's head (silly but works) |
| **Confetti** | Particle system + rain `candy_*` + `gem_*` + `star` items at small scale |

This is the complete, real-path asset map. Feed this alongside the other two documents to Claude Code.
