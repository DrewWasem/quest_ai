...
export const FALLBACK_SCRIPTS: Record<string, SceneScript> = {
  'skeleton-birthday': {
    ...
    actions: [
      ...
      { type: 'emote', target: 'skeleton_warrior', emoji: '🎂', text: "It's my birthday!" },
      { type: 'spawn', target: 'knight', position: 'off-left', delay_ms: 600 },
      { type: 'move', target: 'knight', to: 'left', style: 'bounce', delay_ms: 200 },
      { type: 'emote', target: 'knight', emoji: '🎁', text: "I brought a gift!", delay_ms: 400 },
      ...
      { type: 'emote', target: 'clown', emoji: '🤡', text: "Party time?", delay_ms: 300 },
      { type: 'react', effect: 'question-marks', position: 'center', delay_ms: 400 },
    ],
    prompt_feedback: "The party is starting! Tell the characters what to do — who brings the cake? Who dances?",
  ...
  'knight-space': {
    ...
    actions: [
      ...
      { type: 'emote', target: 'robot', emoji: '🤖', text: "Systems offline!", delay_ms: 400 },
      ...
      { type: 'emote', target: 'space_ranger', emoji: '😰', text: "We're drifting!", delay_ms: 400 },
    ...
    guide_hint: 'Try telling each character a specific job — like "the engineer fixes the solar panel"!',
    prompt_analysis: { has_character: false, has_action: false, has_sequence: false, has_detail: false, has_multi_char: false, has_environment: false },
  },
  ...
  'barbarian-school': {
    ...
    actions: [
      ...
      { type: 'emote', target: 'barbarian', emoji: '💪', text: "Let's wrestle!", delay_ms: 400 },
      { type: 'spawn', target: 'clown', position: 'off-right', delay_ms: 600 },
      { type: 'move', target: 'clown', to: 'right', style: 'bounce', delay_ms: 200 },
      { type: 'emote', target: 'clown', emoji: '🎪', text: "No, let's juggle!", delay_ms: 400 },
      { type: 'spawn', target: 'ninja', position: 'off-left', delay_ms: 500 },
      { type: 'move', target: 'ninja', to: 'center', style: 'linear', delay_ms: 200 },
      { type: 'emote', target: 'ninja', emoji: '🤫', text: "Let's sneak...", delay_ms: 400 },
  ...
  'skeleton-pizza': {
    ...
    actions: [
      { type: 'spawn', target: 'skeleton_warrior', position: 'center' },
      { type: 'emote', target: 'skeleton_warrior', emoji: '📋', text: "What's the order?!", delay_ms: 400 },
      { type: 'spawn', target: 'clown', position: 'off-left', delay_ms: 600 },
      { type: 'move', target: 'clown', to: 'left', style: 'bounce', delay_ms: 200 },
      { type: 'emote', target: 'clown', emoji: '🍕', text: "I'll make pizza!", delay_ms: 400 },
      ...
      { type: 'emote', target: 'superhero', emoji: '🔥', text: "The oven's on fire!", delay_ms: 400 },
  ...
  'adventurers-picnic': {
    ...
    actions: [
      ...
      { type: 'emote', target: 'ranger', emoji: '👀', text: "What's that glow?", delay_ms: 400 },
      { type: 'spawn', target: 'druid', position: 'off-right', delay_ms: 600 },
      { type: 'move', target: 'druid', to: 'right', style: 'linear', delay_ms: 200 },
      { type: 'emote', target: 'druid', emoji: '✨', text: "I sense magic!", delay_ms: 400 },
      ...
      { type: 'emote', target: 'barbarian', emoji: '🤷', text: "Can I eat it?", delay_ms: 400 },
    ],
  ...
  'dungeon-concert': {
    ...
    actions: [
      ...
      { type: 'emote', target: 'knight', emoji: '⚔️', text: "I'll smash it open!", delay_ms: 400 },
      { type: 'spawn', target: 'rogue', position: 'off-right', delay_ms: 600 },
      { type: 'move', target: 'rogue', to: 'right', style: 'linear', delay_ms: 200 },
      { type: 'emote', target: 'rogue', emoji: '🔑', text: "No! Let me pick it!", delay_ms: 400 },
      { type: 'spawn', target: 'mage', position: 'off-left', delay_ms: 500 },
      { type: 'move', target: 'mage', to: 'center', style: 'linear', delay_ms: 200 },
      { type: 'emote', target: 'mage', emoji: '🤔', text: "What if it's trapped?", delay_ms: 400 },
    ],
    prompt_feedback: "You need an escape plan! Tell each character what to do — who sneaks, who fights, who casts spells?",
  ...
  'mage-kitchen': {
    ...
    actions: [
      ...
      { type: 'emote', target: 'mage', emoji: '🪄', text: "Kitchen, behave!", delay_ms: 400 },
      ...
      { type: 'emote', target: 'witch', emoji: '😱', text: "The pot is alive!", delay_ms: 400 },
