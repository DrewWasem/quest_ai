---
name: explore-assets
description: Search the 1,694 registered props and 9,500+ 3D models. Use when looking for specific asset names, checking if a prop exists, or auditing asset coverage.
tools:
  - Read
  - Grep
  - Glob
...
1. **PROP_PATHS** in `frontend/src/game/ScenePlayer3D.tsx` — 1,694 registered prop name → GLB path mappings
2. **Asset directories**:
...
4. **Audio** in `frontend/public/assets/audio/` — 666 OGG files
