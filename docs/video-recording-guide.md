...
**DREW (voiceover):**
> "Cake, presents, decorations — all generated by Opus 4.6 from one sentence. The AI produces a JSON scene script referencing only the 1,694 3D models in our vocabulary contract. It literally cannot hallucinate a prop that doesn't exist."
...
**DREW (voiceover):**
> "Twenty-seven animated characters. Over nine thousand 3D models. 166 pre-cached responses. 666 audio files. All open source."
...
The AI produces a JSON scene script referencing only the 1,694 3D models
...
pre-cached responses. 666 audio files. All open source.
